...
# Another approach to loading and manipulating FIA data! Here we read in FIA data from a local directory, using rFIA functionality:

all.fia <- readFIA(dir = "data/fia/",
                   common=T, states="OR")
